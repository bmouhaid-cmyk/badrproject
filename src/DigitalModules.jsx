          ...
          <div className="bg-white rounded-xl shadow-lg w-full max-w-4xl max-h-[90vh] flex flex-col">
            <div className="p-6 border-b flex justify-between items-center">
              <h4 className="text-xl font-bold text-gray-800">
                {selectedKpi === 'solde_global' && 'Détails du Solde Global Digital'}
                {selectedKpi === 'total_entrees' && 'Détails des Entrées Digitales'}
                {selectedKpi === 'total_sorties' && 'Détails des Sorties Digitales'}
                    ...
                    {digitalTransactions
                      .filter(t => {
                        ...
                        if (selectedKpi === 'total_sorties') {
                          return (t.type === 'purchase' || t.type === 'expense' || t.type === 'supplier_payment' || t.type === 'liquidity_remove') && t.bank_account_id;
                        }
                        return true;
                      })
                      .sort((a, b) => new Date(b.date) - new Date(a.date))
                      ...
                      {digitalTransactions.filter(t => {
                        ...
                        if (selectedKpi === 'total_sorties') return (t.type === 'purchase' || t.type === 'expense' || t.type === 'supplier_payment' || t.type === 'liquidity_remove') && t.bank_account_id;
                        return true;
                      }).length === 0 && (
                        <tr>
